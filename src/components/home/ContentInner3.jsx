...
const ContentInner3 = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-brand-navy py-24 overflow-hidden"
    >
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-bottom-img relative group">
          ...
          <div className="animate-bottom-text relative z-10">
